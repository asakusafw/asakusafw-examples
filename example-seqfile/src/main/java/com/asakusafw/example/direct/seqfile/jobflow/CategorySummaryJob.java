...
import com.asakusafw.example.direct.seqfile.modelgen.dmdl.model.ErrorRecord;
...
import com.asakusafw.example.direct.seqfile.operator.CategorySummaryOperatorFactory;
import com.asakusafw.example.direct.seqfile.operator.CategorySummaryOperatorFactory.CheckStore;
import com.asakusafw.example.direct.seqfile.operator.CategorySummaryOperatorFactory.JoinItemInfo;
import com.asakusafw.example.direct.seqfile.operator.CategorySummaryOperatorFactory.SetErrorMessage;
import com.asakusafw.example.direct.seqfile.operator.CategorySummaryOperatorFactory.SummarizeByCategory;
...
public class CategorySummaryJob extends FlowDescription {
    ...
    public CategorySummaryJob(
            @Import(name = "salesDetail", description = SalesDetailFromSeqFile.class)
            In<SalesDetail> salesDetail,
            @Import(name = "storeInfo", description = StoreInfoFromSeqFile.class)
            In<StoreInfo> storeInfo,
            @Import(name = "itemInfo", description = ItemInfoFromSeqFile.class)
            In<ItemInfo> itemInfo,
            @Export(name = "categorySummary", description = CategorySummaryToSeqFile.class)
