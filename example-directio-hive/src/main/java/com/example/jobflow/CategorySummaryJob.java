...
public class CategorySummaryJob extends FlowDescription {
    ...
    public CategorySummaryJob(
            @Import(name = "salesDetail", description = SalesDetailFromOrc.class)
            In<SalesDetail> salesDetail,
            @Import(name = "storeInfo", description = StoreInfoFromParquet.class)
            In<StoreInfo> storeInfo,
            @Import(name = "itemInfo", description = ItemInfoFromParquet.class)
            In<ItemInfo> itemInfo,
            @Export(name = "categorySummary", description = CategorySummaryToOrc.class)
            Out<CategorySummary> categorySummary,
            @Export(name = "errorRecord", description = ErrorRecordToParquet.class)
