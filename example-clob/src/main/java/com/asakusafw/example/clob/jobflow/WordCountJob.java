 ...
 */
package com.asakusafw.example.clob.jobflow;
...
import com.asakusafw.example.clob.operator.WordCountOperatorFactory;
import com.asakusafw.example.clob.operator.WordCountOperatorFactory.ExtractDocument;
import com.asakusafw.example.clob.operator.WordCountOperatorFactory.FoldWords;
...
public class WordCountJob extends FlowDescription {
     ...
     */
    public WordCountJob(
            @Import(name = "documents", description = DocumentFromDb.class)
            In<Document> documents,
            @Export(name = "words", description = WordIntoDb.class)
            Out<Word> words) {
